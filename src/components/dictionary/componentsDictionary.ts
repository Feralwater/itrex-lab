export const componentsDictionary = {
  message: {
    ...
    successMessageBodyCreateNewPatient: 'You have successfully created a new patient.',
    successMessageBodyCreateNewDoctor: 'You have successfully created a new doctor.',
